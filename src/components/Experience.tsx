...
const steps = [
  ...
  { title: "Medical Treatment", body: "We build the treatment record that proves what the accident actually did to you, from the first visit through any specialist care that follows.", points: ["Records, imaging, and specialist care", "Ongoing and future treatment needs"], image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1400&q=88" },
