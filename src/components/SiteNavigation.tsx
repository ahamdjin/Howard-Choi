...
const SiteNavigation = ({ locale }: { locale: SiteLocale }) => {
  ...
  return (
    ...
    >
      <div className="h-[60px] px-4 sm:px-5 lg:px-7 xl:px-8">
        <div className="hidden h-full grid-cols-[minmax(215px,0.95fr)_minmax(580px,2.25fr)_minmax(190px,0.8fr)] items-center lg:grid">
