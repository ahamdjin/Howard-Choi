...
export const Route = createFileRoute("/blogs/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    const seo = buildSeo({ title: `${loaderData.title} | Buena Park Injury Lawyer`, description: loaderData.excerpt, path, alternatePath: `/ko/blogs/${loaderData.slug}`, locale: "en-US", type: "article", image: loaderData.image });
    return {
      ...seo,
